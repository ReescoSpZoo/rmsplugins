    ...
    Excel.run(function (ctx) {
        ...
        return ctx.sync()
            .then(function () {
                ...
                var welcomeSheet = ctx.workbook.worksheets.add("Witaj");

                // Create strings to store all static content to display in the Welcome sheet
                var sheetTitle = "RMS w EXCEL";
                var sheetHeading1 = "Dzięki temu dodatkowi możesz:";
                var sheetDesc1 = "1.  Zarządzać umowami w projecie";
                var sheetDesc2 = "2.  Zawsze posiadać aktualną bazę kontaktów";
                var sheetDesc3 = "3.  Pomóc na z importem pozycji z LCC to bazy danych RMS";
